...
<body>
    ...
    <form class="max-w-sm mx-auto mt-5" action="/store" method="POST">
        @csrf
        ...
        <div class="mb-5">
          ...
          <input type="text" name="gen" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="gen" required />
        </div>
